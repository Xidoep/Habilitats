...
namespace Moviment3D
{
    ...
    public static class ExtensionsInformacio
    {
        ...
        public static bool Relliscar(this Vector3 vector3) => Vector3.Dot(vector3, Vector3.up) == Mathf.Clamp(Vector3.Dot(vector3, Vector3.up), 0.65f, 0.8f);
        public static bool Relliscar(this RaycastHit raycastHit) => raycastHit.collider.GetComponent<Relliscable>() != null;
